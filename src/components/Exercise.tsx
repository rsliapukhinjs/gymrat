  ...
  return (
    <div className="flex-1 p-8 flex flex-col items-center gap-8  bg-slate-700">
      ...
      <div className="flex flex-col gap-4 items-center">
        <div className="w-3/4 grid grid-cols-2 border-2">
          <div className="p-8 flex flex-col gap-8 uppercase font-bold text-5xl items-center justify-center">
            <h3>{currentExercise.Category}</h3>
            <h3>{currentExercise.target.Primary}</h3>
          </div>
          <ul className="w-full p-8 flex flex-col items-start justify-center gap-8 bg-teal-700">
